    ...
    this.clientesService.editarCliente(clienteId, this.form.value).subscribe({
      next: () => {
        Swal.fire({
          ...
          html: '<strong>O cliente foi editado com sucesso!</strong><br>Você será redirecionado para a lista de clientes automaticamente em <span class="countdown">5</span> segundos.',
